...
public class GuiMainMenu extends GuiScreen {
	...
	private static final String DEFAULT_DISCORD = "https://discord.com/invite/yVAQtjgWy4";
	...
	public void initGui() {
		...
		String configDiscord = getDiscordFromConfig();
    	if (configDiscord != null && !configDiscord.isEmpty()) {
    	    this.discordLink = configDiscord;
    	} else {
    	    this.discordLink = DEFAULT_DISCORD;
    	}
		...
		this.buttonList.add(new GuiButton(99, this.width / 2 - 100, j + 72 + 12 + 24, 200, 20, "Discord"));
	}
    ...
    params = {},
    script = "return (typeof window.eaglercraftXOpts !== 'undefined' && window.eaglercraftXOpts.discord) ? window.eaglercraftXOpts.discord : null;"
	)
	private static native String getDiscordFromConfig();
	@org.teavm.jso.JSBody(
    	params = {"url"},
    	script = "window.open(url, '_blank').focus();"
	)
	private static native String openWebLink(String url);
}
